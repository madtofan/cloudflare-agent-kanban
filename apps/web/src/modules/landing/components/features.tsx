      ...
      <div className="grid gap-8 md:grid-cols-3">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Transform your project boards into a stunning public
              portfolio. Share your work with the world.
            </CardDescription>
          </CardHeader>
        </Card>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Tailor your profile page to stand out. Add a bio, showcase
              your best projects, and tell your story.
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
